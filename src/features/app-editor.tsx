import * as syntax from "@/lib/goboscriptSyntax"
import {editor, fs, monaco, selectedFile} from "@/lib/state"
import {cn} from "@/lib/utils"
import {Editor} from "@monaco-editor/react"
import * as editorTypes from "monaco-editor"

const theme: editorTypes.editor.IStandaloneThemeData = {
    base: "vs-dark",
    inherit: true,
    rules: [
        {
    ...
    colors: {
        ...
        "editor.background": "#0A0A0A", // 0A0A0A
...
export function AppEditor() {
    ...
    return (
        <div className="h-full grow p-2 pt-0">
            <Editor
